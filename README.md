...
### ধাপ ৩ — প্রসেস করুন: এক এক করে, বা Full Auto

**এক এক করে (ম্যানুয়াল, রিভিউ করে সেভ করতে চাইলে):**
...
**Full Auto (বাকি সব রো নিজে নিজে):**
- **"⚡ Full Auto (N বাকি)"** চাপুন — যতগুলো রো এখনো সম্পন্ন হয়নি, সবগুলো একের পর এক Claude-এ পাঠাবে এবং সরাসরি সেভ করবে
- কোনো রিভিউ/এডিট করার সুযোগ থাকে না — উত্তর যেভাবে আসে সেভাবেই সেভ হয়, তাই প্রথমে কয়েকটা রো ম্যানুয়ালি করে prompt/format ঠিক আছে কিনা যাচাই করে নেওয়া ভালো
- চলার সময় progress bar-এ দেখা যাবে কোন রো চলছে; কোনো রো ব্যর্থ হলে সেটা স্কিপ করে বাকিগুলো চালিয়ে যায়, শেষে কোন কোন রো ব্যর্থ হয়েছে তার তালিকা দেখাবে
- একবার শুরু হলে মাঝপথে থামানোর উপায় নেই — শেষ পর্যন্ত চলবে, তাই বড় ফাইলে চালানোর আগে ছোট একটা ফাইলে টেস্ট করে নিন

> লগইন সেশন expire হয়ে গেলে পাঠানোর সময় একটা স্পষ্ট error দেখাবে — তখন ধাপ ০ আবার করুন।
